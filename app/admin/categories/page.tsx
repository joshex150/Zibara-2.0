    ...
    <div className="min-h-screen bg-[#EBB0C9] flex flex-col scroll-mt-32">
      <div className="max-w-7xl mx-auto px-4 py-8 w-full flex-1 flex flex-col">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 md:mb-8">
          ...
          <button
            onClick={() => openModal()}
            className="flex items-center justify-center gap-2 bg-[#8b2b4d] text-white px-4 md:px-6 py-2 md:py-3 rounded-lg text-sm md:text-base font-semibold hover:bg-[#6d1f3a] transition-colors"
          >
        ...
        {categories.length === 0 ? (
          <div className="bg-[#8b2b4d] rounded-lg p-8 md:p-12 text-center flex-1 flex flex-col items-center justify-center">
            ...
            <button
              onClick={() => openModal()}
              className="inline-flex items-center gap-2 bg-white text-[#8b2b4d] px-4 md:px-6 py-2 md:py-3 rounded-lg text-xs md:text-sm font-semibold hover:bg-gray-100 transition-colors"
            >
          ...
          <div className="space-y-3 md:space-y-4">
            {categories.map((category) => (
              <div 
                key={category._id} 
                className={`bg-[#f5d5e5] rounded-lg shadow-md p-4 md:p-5 flex flex-col sm:flex-row sm:items-center gap-4 ${
              ...
              >
                ...
                <div className="flex items-center gap-3 md:gap-4 flex-1 min-w-0">
                  ...
                  {category.image ? (
                    ...
                    <div className="w-12 h-12 md:w-16 md:h-16 bg-[#8b2b4d]/10 rounded-lg flex items-center justify-center shrink-0">
                      <FolderOpen className="w-5 h-5 md:w-6 md:h-6 text-[#8b2b4d]/50" />
                    </div>
                  )}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {!category.isActive && (
                        <span className="text-[10px] md:text-xs bg-gray-500 text-white px-2 py-0.5 rounded">
                          Hidden
                        </span>
                      )}
                    </div>
                ...
                <div className="flex items-center gap-2 mt-auto sm:mt-0">
                  ...
                  <button
                    ...
                    className="p-2 bg-[#8b2b4d] text-white rounded-lg hover:bg-[#6d1f3a] transition-colors"
                    title="Edit category"
                  >
      ...
      {modalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-[#f5d5e5] rounded-lg max-w-lg w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-4 md:p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#8b2b4d] focus:border-transparent bg-white"
              ...
              <div className="flex gap-3 pt-4">
                <button
                  type="button"
                  onClick={closeModal}
                  className="flex-1 py-2.5 border border-[#8b2b4d]/20 rounded-lg text-sm font-semibold hover:bg-gray-100 transition-colors"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  disabled={saving}
                  className="flex-1 bg-[#8b2b4d] text-white py-2.5 rounded-lg text-sm font-semibold hover:bg-[#6d1f3a] transition-colors disabled:opacity-50"
                >
