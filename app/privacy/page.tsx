    ...
    <div className="min-h-screen bg-zibara-black text-zibara-cream pt-24 md:pt-28">
      <div className="max-w-[900px] mx-auto px-4 md:px-8 pb-16">
        ...
        <div className="space-y-6 text-[11px] md:text-xs font-mono leading-loose text-zibara-cream/75">
          ...
          <div className="bg-zibara-deep/50 border border-zibara-cream/10 p-6 md:p-8">
            <h2 className="text-xs md:text-sm font-mono uppercase tracking-[0.25em] text-zibara-cream mb-5">Information We Collect</h2>
          ...
          <div className="bg-zibara-deep/50 border border-zibara-cream/10 p-6 md:p-8">
            <h2 className="text-xs md:text-sm font-mono uppercase tracking-[0.25em] text-zibara-cream mb-5">How We Use Your Information</h2>
          ...
          <div className="bg-zibara-deep/50 border border-zibara-cream/10 p-6 md:p-8">
            <h2 className="text-xs md:text-sm font-mono uppercase tracking-[0.25em] text-zibara-cream mb-5">Sharing Your Information</h2>
          ...
          <div className="bg-zibara-deep/50 border border-zibara-cream/10 p-6 md:p-8">
            <h2 className="text-xs md:text-sm font-mono uppercase tracking-[0.25em] text-zibara-cream mb-5">Cookies and Tracking</h2>
          ...
          <div className="bg-zibara-deep/50 border border-zibara-cream/10 p-6 md:p-8">
            <h2 className="text-xs md:text-sm font-mono uppercase tracking-[0.25em] text-zibara-cream mb-5">Data Security</h2>
          ...
          <div className="bg-zibara-deep/50 border border-zibara-cream/10 p-6 md:p-8">
            <h2 className="text-xs md:text-sm font-mono uppercase tracking-[0.25em] text-zibara-cream mb-5">Your Rights</h2>
          ...
          <div className="bg-zibara-deep/50 border border-zibara-cream/10 p-6 md:p-8">
            <h2 className="text-xs md:text-sm font-mono uppercase tracking-[0.25em] text-zibara-cream mb-5">Children&apos;s Privacy</h2>
          ...
          <div className="bg-zibara-deep/50 border border-zibara-cream/10 p-6 md:p-8">
            <h2 className="text-xs md:text-sm font-mono uppercase tracking-[0.25em] text-zibara-cream mb-5">International Transfers</h2>
          ...
          <div className="bg-zibara-deep/50 border border-zibara-cream/10 p-6 md:p-8">
            <h2 className="text-xs md:text-sm font-mono uppercase tracking-[0.25em] text-zibara-cream mb-5">Changes to This Policy</h2>
          ...
          <div className="bg-zibara-deep/50 border border-zibara-cream/10 p-6 md:p-8">
            <h2 className="text-xs md:text-sm font-mono uppercase tracking-[0.25em] text-zibara-cream mb-5">Contact Us</h2>
