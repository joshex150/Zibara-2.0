    ...
    <div className="min-h-screen bg-zibara-black text-zibara-cream pt-24 md:pt-28">
      <div className="max-w-[900px] mx-auto px-4 md:px-8 pb-16">
        ...
        <div className="space-y-0 text-[11px] md:text-xs font-mono leading-loose text-zibara-cream/75">
          ...
          <div className="border-t border-zibara-cream/10 pt-8 pb-10">
            <h2 className="text-[9px] tracking-[0.45em] font-mono uppercase text-zibara-cream/65 mb-6">Information We Collect</h2>
          ...
          <div className="border-t border-zibara-cream/10 pt-8 pb-10">
            <h2 className="text-[9px] tracking-[0.45em] font-mono uppercase text-zibara-cream/65 mb-6">How We Use Your Information</h2>
          ...
          <div className="border-t border-zibara-cream/10 pt-8 pb-10">
            <h2 className="text-[9px] tracking-[0.45em] font-mono uppercase text-zibara-cream/65 mb-6">Sharing Your Information</h2>
          ...
          <div className="border-t border-zibara-cream/10 pt-8 pb-10">
            <h2 className="text-[9px] tracking-[0.45em] font-mono uppercase text-zibara-cream/65 mb-6">Cookies and Tracking</h2>
          ...
          <div className="border-t border-zibara-cream/10 pt-8 pb-10">
            <h2 className="text-[9px] tracking-[0.45em] font-mono uppercase text-zibara-cream/65 mb-6">Data Security</h2>
          ...
          <div className="border-t border-zibara-cream/10 pt-8 pb-10">
            <h2 className="text-[9px] tracking-[0.45em] font-mono uppercase text-zibara-cream/65 mb-6">Your Rights</h2>
          ...
          <div className="border-t border-zibara-cream/10 pt-8 pb-10">
            <h2 className="text-[9px] tracking-[0.45em] font-mono uppercase text-zibara-cream/65 mb-6">Children&apos;s Privacy</h2>
          ...
          <div className="border-t border-zibara-cream/10 pt-8 pb-10">
            <h2 className="text-[9px] tracking-[0.45em] font-mono uppercase text-zibara-cream/65 mb-6">International Transfers</h2>
          ...
          <div className="border-t border-zibara-cream/10 pt-8 pb-10">
            <h2 className="text-[9px] tracking-[0.45em] font-mono uppercase text-zibara-cream/65 mb-6">Changes to This Policy</h2>
          ...
          <div className="border-t border-zibara-cream/10 pt-8 pb-10">
            <h2 className="text-[9px] tracking-[0.45em] font-mono uppercase text-zibara-cream/65 mb-6">Contact Us</h2>
